...
if run_button:
    ...
    n_demo_replicates = 15  # small enough to stay fast, large enough to stabilize the average
    attack_rates = []
    curves = []  # store (t, I, R) for plotting one representative run
    ...
    # Plot the FIRST replicate as a representative curve
    t, I, R = curves[0]
